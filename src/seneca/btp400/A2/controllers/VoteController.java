 ...
 * @since 2020-03-20
 * @version 1.0 Generates radiobuttons for each candidate and put them on
 *          screen. Takes in user input for their vote.
 */
...
public class VoteController implements Initializable {
	...
	/**
	 * Checks if one of the candidates has been selected. If true, moves user to the
	 * confirmation scene else gives user warning
	 * 
	...
	/**
	 * Get Candidates from the database and generates a CandidateToggleButton for
	 * them
	 * 
	 * @throws SQLException
	 */
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		candidateToggleGrp = new ToggleGroup(); // this line gave me so much trouble- ffs actually initialize stuff ruby
												// -R
		try {
			db = new dbAccessObj();
			getCandidates();
